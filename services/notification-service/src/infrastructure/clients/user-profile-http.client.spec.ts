...
describe("UserProfileHttpClient (notification-service)", () => {
  ...
  it("sends service JWT from notification-service issuer", async () => {
    ...
    await client.lookupReplicas({ userIds: ["user-1"] });
