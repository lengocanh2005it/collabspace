...
describe('UpdateTaskDetailsHandler', () => {
  ...
  it('should update task details successfully', async () => {
    ...
    const command = new UpdateTaskDetailsCommand('123e4567-e89b-12d3-a456-426614174000', 'New Title', 'New Desc');
  ...
  it('should throw BusinessRuleException if title is empty', async () => {
    const task = createMockTask();
    const command = new UpdateTaskDetailsCommand('123e4567-e89b-12d3-a456-426614174000', '', 'New Desc');
