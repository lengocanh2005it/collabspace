...
describe('EditCommentHandler', () => {
  ...
  it('should edit comment successfully', async () => {
    const command = new EditCommentCommand('123e4567-e89b-12d3-a456-426614174000', '123e4567-e89b-12d3-a456-426614174001', 'author-1', 'New Content');
  ...
  it('should throw ForbiddenException if author does not own comment', async () => {
    const command = new EditCommentCommand('123e4567-e89b-12d3-a456-426614174000', '123e4567-e89b-12d3-a456-426614174001', 'author-2', 'New Content'); // different author
    const task = createMockTask();
    const comment = createMockComment('author-1');
