...
export class TaskResponseSchemaDto {
  ...
  assignedTo!: TaskUserResponseSchemaDto | null;
...
export class GetTaskBoardResponseSchemaDto {
  @ApiProperty({ format: "uuid" }) workspaceId!: string;
  @ApiProperty({ type: [TaskBoardColumnSchemaDto] })
  columns!: TaskBoardColumnSchemaDto[];
  @ApiProperty() total!: number;
}
...
export class TaskActivityResponseSchemaDto {
  @ApiProperty({ type: [TaskActivityItemSchemaDto] })
  items!: TaskActivityItemSchemaDto[];
  @ApiProperty() total!: number;
}
...
export class ApiSuccessTaskResponseSchemaDto {
  ...
  @ApiPropertyOptional({ type: ApiSuccessMetaSchemaDto })
  meta?: ApiSuccessMetaSchemaDto;
}

export class ApiSuccessCreateTaskResponseSchemaDto {
  @ApiProperty({ example: true }) success!: boolean;
  @ApiProperty({ type: CreateTaskResponseSchemaDto })
  data!: CreateTaskResponseSchemaDto;
}

export class ApiSuccessGetTasksResponseSchemaDto {
  @ApiProperty({ example: true }) success!: boolean;
  @ApiProperty({ type: GetTasksResponseSchemaDto })
  data!: GetTasksResponseSchemaDto;
}

export class ApiSuccessTaskBoardResponseSchemaDto {
  @ApiProperty({ example: true }) success!: boolean;
  @ApiProperty({ type: GetTaskBoardResponseSchemaDto })
  data!: GetTaskBoardResponseSchemaDto;
}

export class ApiSuccessTaskActivityResponseSchemaDto {
  @ApiProperty({ example: true }) success!: boolean;
  @ApiProperty({ type: TaskActivityResponseSchemaDto })
  data!: TaskActivityResponseSchemaDto;
}
