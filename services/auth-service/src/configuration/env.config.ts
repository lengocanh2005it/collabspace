...
export default () => ({
  ...
  redis: {
    ...
    mode: (process.env.REDIS_MODE ?? 'standalone') as 'standalone' | 'sentinel',
    password: process.env.REDIS_PASSWORD,
    port: toNumber(process.env.REDIS_PORT, 6379),
    sentinelCommandTimeoutMs: toNumber(process.env.REDIS_SENTINEL_COMMAND_TIMEOUT_MS, 5000),
    sentinelConnectTimeoutMs: toNumber(process.env.REDIS_SENTINEL_CONNECT_TIMEOUT_MS, 10000),
