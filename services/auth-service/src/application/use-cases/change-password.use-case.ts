import type { ChangePasswordRequestDto } from '@/application/dto/auth-request.dto';
...
export class ChangePasswordUseCase {
  ...
  async execute(
    ...
    await this.userRepository.changePassword(userId, input.currentPassword, input.newPassword);
