...
export class InternalUsersController {
  constructor(private readonly lookupUserReplicasUseCase: LookupUserReplicasUseCase) {}
  ...
  async lookupReplicas(@Req() request: Request, @Body() body: LookupUserReplicasRequestDto) {
