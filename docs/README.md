...
| [kafka-debezium-migration-roadmap.md](./kafka-debezium-migration-roadmap.md) | **Lộ trình migrate** RabbitMQ → Kafka + Debezium CDC — **Done** local (Phase 0–7); §1.1 = kiến trúc hiện tại |
